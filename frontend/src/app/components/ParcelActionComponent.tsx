...
const ParcelActionComponent: React.FC<{ parcelAction: ParcelActions }> = ({ parcelAction }) => {
    ...
    return (
        <div className ="container mx-auto flex justify-between items-center rounded-lg p-2 hover:bg-gray-100">
        <div className ="text-lg font-semibold text-gray-800 mr-2">{formattedDate}</div>
        <div className ="text-lg font-semibold text-gray-800 ml-2">{parcelAction.details}</div>
        </div>
    );
}
